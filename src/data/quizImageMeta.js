...
export const QUIZ_IMAGE_META = {
  ...
  varsity:         { imageMode: IMAGE_MODES.FULL_BODY,  objectPosition: 'center top',    allowLifestyle: false, allowProductOnly: true,  minSubjectCoverage: 0.65 },
  ...
  mary_janes:      { imageMode: IMAGE_MODES.PAIR,       objectPosition: 'center center', allowLifestyle: false, allowProductOnly: true,  minSubjectCoverage: 0.55 },
  ...
  combat_boots:    { imageMode: IMAGE_MODES.PAIR,       objectPosition: 'center center', allowLifestyle: false, allowProductOnly: true,  minSubjectCoverage: 0.55 },
...
export const ITEM_BASE_QUERY = {
  ...
  basic_tee:       'women essential white tee fitted model fashion',
  oversized_tee:   'women oversized boyfriend tee shirt outfit fashion',
  crop_top:        'women ribbed crop top retail model white background asos',
  ...
  bodysuit:        'women ribbed bodysuit top fashion model outfit',
  ...
  midi_skirt:      'women satin pleated midi skirt fashion model front',
  ...
  varsity:         'women varsity letterman jacket front view',
  chunky_cardigan: 'oversized chunky knit cardigan women cozy fall',
  knit_cardigan:   'women knit cardigan sweater',
  hoodie:          'women pullover hoodie sweatshirt',
  bomber:          'women satin bomber jacket standing model front view',

  white_sneakers:  'white low-top sneakers shoes',
  chunky_sneakers:  'chunky platform sneakers shoes women',
  mary_janes:      'mary jane heels shoes women pair',
  heeled_boots:    'women heeled ankle boots',
  combat_boots:    'lace-up combat boots women pair black',
  ...
  sunglasses:        'fashion sunglasses pair isolated white background product photo',
